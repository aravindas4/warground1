...
fn main() {
    ...
    println!("Arguments can be referred to by thier position: {0}, {1}! and {1}, {0}! are built from same arguments", "Hello", "world");
    println!("Furthermore arguments can be named: \"{greeting},{object}\"", greeting="Hello", object="world");
